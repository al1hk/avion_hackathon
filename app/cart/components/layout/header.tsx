...
<<<<<<< HEAD
          ...
          <Link href="/about/" className="block lg:inline-block py-3 px-4 lg:p-0 text-xl text-black font-serif hover:text-gray-800 font-montserrat tracking-wide hover:bg-gray-50 lg:hover:bg-transparent">
            About
          </Link>
